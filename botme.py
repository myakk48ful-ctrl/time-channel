...
BOT_TOKEN = "8540326761:AAEXfzXs_fMUzg3vvXJ7RPWUZ76SAVVTA2U"                      # ← توکن ربات
ADMIN_IDS = [8495518263]                  # ← آیدی ادمین (عدد)
DEFAULT_TZ = "Asia/Tehran"               # تایم‌زون پیش‌فرض
DB_PATH = "bot.db"                       # فایل دیتابیس SQLite
DEFAULT_INTERVAL = 60                    # بازه آپدیت پیش‌فرض (ثانیه)
# ── PROXY ───────────────────────────────────────────────────────────────────
# اگر api.telegram.org از شبکه‌ی شما قابل‌دسترسی نیست (مثلاً فیلترینگ)،
# اینجا آدرس پروکسی را بگذار. نمونه‌ها:
#   PROXY = "socks5://s5.foriran.co.uk:443"        ← پروکسی HTTP محلی
#   PROXY = "socks5://bfesedv.uk:4455"      ← پروکسی SOCKS5 محلی
# اگر ندارید، مقدار را خالی بگذارید ("" یا None) تا بدون پروکسی کار کند.
PROXY = ""
# ────────────────────────────────────────────────────────────────────────────
